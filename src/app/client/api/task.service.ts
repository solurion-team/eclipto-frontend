...
export class TaskService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getTaskDescription(taskDescriptionRequest: TaskDescriptionRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<TaskDescriptionResult>;
    public getTaskDescription(taskDescriptionRequest: TaskDescriptionRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<TaskDescriptionResult>>;
    public getTaskDescription(taskDescriptionRequest: TaskDescriptionRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<TaskDescriptionResult>>;
    public getTaskDescription(taskDescriptionRequest: TaskDescriptionRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (taskDescriptionRequest === null || taskDescriptionRequest === undefined) {
            throw new Error('Required parameter taskDescriptionRequest was null or undefined when calling getTaskDescription.');
        }
